    ...
    $.ajax({
          ...
          success: function(data) {
             ...
             if(data == "1"){
                    ...
                    swal({
                    title: "Error!",
                    text: "ERROR Area already existing in our system !!",
                    type: "error",
                    button: "OK!",
                  }, function () {
    ...
    $.ajax({
          ...
          success: function(data) {
             ...
             if(data == "1"){
                    ...
                    swal({
                    title: "Error!",
                    text: "ERROR Benefits already existing in our system !!",
                    type: "error",
                    button: "OK!",
                  }, function () {
                     //$('#first-disabled4').html(data);
          ...
          success: function(data) {
           // alert(data);
              ...
              if(data == "1"){
                    ...
                    swal({
                    title: "Error!",
                    text: "ERROR Tecnologies already existing in our system !!",
                    type: "error",
                    button: "OK!",
                  }, function () {
                     //$('#first-disabled4').html(data);
    ...
    $.ajax({
          ...
          success: function(data) {
             ...
             if(data == "1"){
                    ...
                    swal({
                    title: "Error!",
                    text: "ERROR Host already existing in our system !!",
                    type: "error",
                    button: "OK!",
                  }, function () {
                     //$('#first-disabled4').html(data);
