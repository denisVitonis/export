...
if($_SESSION["sgid"]==null or $_SESSION["sgid"]=='' ){
...
<head>
 <meta charset="utf-8">
  ...
  <link rel="stylesheet" href="<?php echo base_url('assets/dist/css/AdminLTE.min.css') ?>">
    ...
    <link rel="stylesheet" type="text/css" href="<?php echo base_url('assets/css/style.css')?>" charset=utf-8>
...
<script src="<?php echo base_url('assets/progressbar/jquery.form.js')?>"></script>
...
<script src="<?php echo base_url('assets/bower_components/datatables.net/js/jquery.dataTables.min.js')?>"></script>
  ...
  <link rel="stylesheet" href="<?php echo base_url('assets/dist/css/bootstrap-multiselect.css')?>" type="text/css" charset=utf-8 >
...
<script src="<?php echo base_url('assets/graficos/Chart.min.js') ?>"></script>
<script src="<?php echo base_url('assets/graficos/utils.js') ?>"></script>
<style>
  canvas{
  ...
  <link rel="stylesheet" type="text/css" href="https://cdn.datatables.net/fixedheader/3.1.5/css/fixedHeader.bootstrap4.min.css">-->
   ...
   <!--<script src="https://ajax.googleapis.com/ajax/libs/jquery/2.1.1/jquery.min.js"></script>
    ...
    <script src="https://ajax.googleapis.com/ajax/libs/jquery/2.1.1/jquery.min.js"></script>
    <script src="<?php //echo base_url('assets//ui/plugins/chosen/chosen.jquery.min.js')?>"></script> -->
...
function excluir_registro() {
 ...
 <script type="text/javascript">
  ...
  var active = "<?php echo  isset($active) ? $active : '' ;?>";
...
<div class="wrapper">
  ...
  <header class="main-header">
    ...
    <a href="" class="logo">
      <!-- mini logo for sidebar mini 50x50 pixels -->
       <div>
          <img src="<?php echo base_url('assets/img/logosaint_white.png'); ?>" alt="SG">
        </div>
    </a>
 ...
 <nav class="navbar navbar-static-top" role="navigation">
   <img src="<?php echo base_url('assets/logwhitepro.png'); ?>" style="width:4em; margin-left:2em;">
